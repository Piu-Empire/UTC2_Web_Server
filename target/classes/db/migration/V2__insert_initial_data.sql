...
VALUES
(2, 'Học kỳ 1 năm 2025-2026', '2025-2026', 1, '2025-09-01', '2026-01-15', 3.45, 18, 18),
...
VALUES
('INT101', 'Nhập môn lập trình', 3, 30, 30, 'CNTT', 'Môn học cơ sở lập trình'),
('DBS201', 'Cơ sở dữ liệu', 3, 30, 30, 'CNTT', 'Thiết kế và quản trị CSDL'),
...
VALUES
(2, 1, 1, 'hoàn thành', 8.5, 9.0, 9.5, 9.0, 'A', 4.0, true),
(2, 2, 1, 'hoàn thành', 7.0, 8.0, 8.5, 7.9, 'B+', 3.5, true),
...
`week_start`, `week_end`)
VALUES
(2, 1, 1, 2, 1, 3, '07:00:00', '09:30:00', 'A101', 'Nhà A', 'TS. Phạm Minh', 1, 15),
...
`attachment_url`)
VALUES
(2, 'Giấy xác nhận sinh viên', 'Xin cấp giấy xác nhận sinh viên', 'hoàn thành',
'2025-09-18 10:00:00',
'Đã gửi file PDF qua email',
'https://cdn.utc2/files/xacnhan.pdf'),

(3, 'Cấp bảng điểm', 'Xin cấp bảng điểm tiếng Anh', 'chờ xử lý',
'2025-09-01 00:00:00',
NULL,
NULL);
